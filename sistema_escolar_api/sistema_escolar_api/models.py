...
#TODO: A partur de aqui se deben de definir los modelos de alumnos y maestros

class Alumnos(models.Model):
    id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=False, blank=False, default=None)
    matricula = models.CharField(max_length=255, null=True, blank=True)
    fecha_nacimiento = models.DateTimeField(auto_now=False, null=True, blank=True)
...
class Eventos(models.Model):
    ...
    hora_final = models.TimeField(auto_now_add=False, null=True, blank=True)
