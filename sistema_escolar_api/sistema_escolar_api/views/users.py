...
class AdminAll(generics.CreateAPIView):
    #Esta función es escencial para todo donde se requiera autorización de inicio de sesión (token)
...
class AdminsViewEdit(generics.CreateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response({'admins': total_admins, 'maestros': total_maestros, 'alumnos': total_alumnos}, status=status.HTTP_200_OK)
